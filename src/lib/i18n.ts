...
const dict = {
  ...
  "order.refunded.title": "Order refunded",
  "order.refunded.body": "This order was refunded in full to your card.",
  ...
  "editor.choosePhoto": "Choose photo",
